...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                // TODO seguro que todas estas rutas se pueden agrupar para hacer este método más sencillo
                .authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/vivienda/**/inmobiliaria/**").hasAnyRole("ADMIN, PROPIETARIO, GESTOR")
                ...
                .antMatchers(HttpMethod.DELETE, "/inmobiliaria/**").authenticated()
                .antMatchers(HttpMethod.GET, "/inmobiliaria/**/gestor").hasAnyRole("ADMIN, PROPIETARIO, GESTOR")
